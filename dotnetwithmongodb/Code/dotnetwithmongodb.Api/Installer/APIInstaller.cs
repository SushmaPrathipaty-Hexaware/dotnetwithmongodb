...
using dotnetwithmongodb.Api.Filters;
using dotnetwithmongodb.BusinessServices.Installer;
using System;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
using Microsoft.Extensions.Logging;
namespace dotnetwithmongodb.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetwithmongodb API", Version = version + "-" + branch});
            });
