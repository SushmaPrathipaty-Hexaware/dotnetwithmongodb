using dotnetwithmongodb.Api.Installer;
using dotnetwithmongodb.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using dotnetwithmongodb.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace dotnetwithmongodb.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetwithmongodb V1");
        });
